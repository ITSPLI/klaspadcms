...
public function insert_board_note(){
   ...
   $this->session->data['messages']='You must Login First.';
	...
	$this->data['CourseLeader']=$record['CourseLeader'];
	$this->data['formtype']=$record['formtype'];
	$this->data['learningoutcomes']=$record['learningoutcomes'];	
	$this->data['imageupload']=$record['imageupload'];
	$this->data['paymenttype']=$record['paymenttype'];
	$this->data['noofpackage']=$record['noofpackage'];
	
	$this->data['whatisitfor']=$record['whatisitfor'];
	$this->data['whatyouwilllearn']=$record['whatyouwilllearn'];
	$this->data['howitisassessed']=$record['howitisassessed'];
		}else{
	}
	$this->id       = 'content';
...
<script>
	...
	$this->load->model('klaspad/klaspad');	
	if(isset($this->session->data['userid'])){	
	$ref=$this->model_klaspad_klaspad->insert_modules();
	if(isset($_GET['moduleid'])){
    $this->session->data['messages']='Module updated successfully';
	}else{
    $this->session->data['messages']='Module added successfully';
	$script = HTTP_SERVER;
$vv= $script."index.php?route=klaspad/klaspad/add_topics&os=module&courseid=".@$_POST['course_id']."&moduleid=".$ref;
header("Location:".$vv);
	}?>
<script>
	   parent.window.hs.getExpander().close();
...
<?php
  ...
  public function excercises_list()
	...
	$this->id       = 'content';
	if(@$_GET['sourcetype']=='direct'){
	$this->template = 'klaspad/list_excercises_direct.php';
	}else{
   ...
   public function resource_list()
	...
	$this->template = 'klaspad/list_resources_direct.php';
	}else{
  ...
  public function add_crosswords()
	...
	$this->id       = 'content';
	if($_GET['sourcetype']=='direct'){
	$this->template = 'klaspad/add_crosswords_direct.php';	
	}else{
	...
	$this->load->model('klaspad/klaspad');	
	if(isset($this->session->data['userid'])){	
	$res=$this->model_klaspad_klaspad->insert_topics();
	//echo $_GET['os'].'S';
	if(@$_GET['topicid']!='' && @$_GET['topicid']!=0){
	...
	//echo 'B';
	$script = HTTP_SERVER;
$vv= $script."index.php?route=klaspad/klaspad/resource_list&moduleid=".$_POST['module_id']."&topicid=".$res;
header("Location:".$vv);
	}?>
   <script>
   parent.window.hs.getExpander().close();
   parent.location.reload();
	...
	$this->load->model('klaspad/klaspad');	
	if(isset($this->session->data['userid'])){	
	$res=$this->model_klaspad_klaspad->insert_headings();
	...
	$script = HTTP_SERVER;
	$modq=mysql_query("select module_id from e_10_edu_topics where id='".$_POST['topic_id']."'");
	$mods=mysql_fetch_array($modq);
	if($_POST['exerciestype']=='Powerpoint presentation exercise'){
	$vv= $script."index.php?route=klaspad/klaspad/add_powerpoint_exercise&sourcetype=direct&type=".urlencode('Powerpoint presentation exercise')."&moduleid=".$mods['module_id']."&topicid=".$_POST['topic_id']."&headingid=".$res;	
	}else if($_POST['exerciestype']=='Files'){
	$vv= $script."index.php?route=klaspad/klaspad/add_files&sourcetype=direct&type=".urlencode('Files')."&moduleid=".$mods['module_id']."&topicid=".$_POST['topic_id']."&headingid=".$res;	
	}else if($_POST['exerciestype']=='Add Video'){
	$vv= $script."index.php?route=klaspad/klaspad/add_video&sourcetype=direct&type=".urlencode('Add Video')."&moduleid=".$mods['module_id']."&topicid=".$_POST['topic_id']."&headingid=".$res;	
	}else if($_POST['exerciestype']=='Fill in the blanks'){
	$vv= $script."index.php?route=klaspad/klaspad/add_fill_in_the_blank&sourcetype=direct&type=".urlencode('Fill in the blanks')."&moduleid=".$mods['module_id']."&topicid=".$_GET['topicid']."&headingid=".$_GET['headingid']."&courseid=".$_GET['courseid']."&resourceid=".$_GET['resourceid'];	
	}else if($_POST['exerciestype']=='Descripting'){
	$vv= $script."index.php?route=klaspad/klaspad/add_descripting&sourcetype=direct&type=".urlencode('Descripting')."&moduleid=".$mods['module_id']."&topicid=".$_GET['topicid']."&headingid=".$_GET['headingid']."&courseid=".$_GET['courseid']."&resourceid=".$_GET['resourceid'];	
	}else if($_POST['exerciestype']=='Write in the correct box'){
	$vv= $script."index.php?route=klaspad/klaspad/add_write_in_the_correct_box&sourcetype=direct&type=".urlencode('Write in the correct box')."&moduleid=".$mods['module_id']."&topicid=".$_GET['topicid']."&headingid=".$_GET['headingid']."&courseid=".$_GET['courseid']."&resourceid=".$_GET['resourceid'];	
	}else if($_POST['exerciestype']=='Crosswords'){
	$vv= $script."index.php?route=klaspad/klaspad/add_crosswords&sourcetype=direct&type=".urlencode('Crosswords')."&moduleid=".$mods['module_id']."&topicid=".$_GET['topicid']."&headingid=".$_GET['headingid']."&courseid=".$_GET['courseid']."&resourceid=".$_GET['resourceid'];	
	}else if($_POST['exerciestype']=='Multiple choice questions'){
	$vv= $script."index.php?route=klaspad/klaspad/add_multiple_choice_questions&sourcetype=direct&type=".urlencode('Multiple choice questions')."&moduleid=".$mods['module_id']."&topicid=".$_GET['topicid']."&headingid=".$_GET['headingid']."&courseid=".$_GET['courseid']."&resourceid=".$_GET['resourceid'];	
	}else if($_POST['exerciestype']=='TrueFalse'){
	$vv= $script."index.php?route=klaspad/klaspad/add_truefalse&sourcetype=direct&type=".urlencode('TrueFalse')."&moduleid=".$mods['module_id']."&topicid=".$_GET['topicid']."&headingid=".$_GET['headingid']."&courseid=".$_GET['courseid']."&resourceid=".$_GET['resourceid'];	
	}else if($_POST['exerciestype']=='Add assignment'){
	$vv= $script."index.php?route=klaspad/klaspad/add_assiement&sourcetype=direct&type=".urlencode('Add assignment')."&moduleid=".$mods['module_id']."&topicid=".$_GET['topicid']."&headingid=".$_GET['headingid']."&courseid=".$_GET['courseid']."&resourceid=".$_GET['resourceid'];	
	}else if($_POST['exerciestype']=='Add discussion'){
	$vv= $script."index.php?route=klaspad/klaspad/add_discussion&sourcetype=direct&type=".urlencode('Add discussion')."&moduleid=".$mods['module_id']."&topicid=".$_GET['topicid']."&headingid=".$_GET['headingid']."&courseid=".$_GET['courseid']."&resourceid=".$_GET['resourceid'];	
	}
...
/*  <a href="index.php?route=klaspad/klaspad/fillintheblank_image_uploaded/'.$record['id'].'" target="_blank"  onclick="return hs.htmlExpand(this, { objectType: \'iframe\', preserveContent: false} );"  >
  <img src="klaspad/images/upload-icon.png" title="upload">
	...
	$i=1;
	foreach($rec as $record){
	$ret.= '<tr id="'.$record['id'].'"><th>'.$i.'.&nbsp;&nbsp;&nbsp;&nbsp;</th><td>'.$record['uploadimage'].'</td><td>';
	$ret.= '</td></tr><tr><td><a href="index.php?route=klaspad/klaspad/add_powerpoint_exercise&moduleid='.$record['moduleid'].'&topicid='.$record['topicid'].'&headingid='.$record['headingid'].'&resourceid='.$record['id'].'&courseid='.$record['course_id'].'" onclick="return parent.hs.htmlExpand(this, { objectType: \'iframe\', preserveContent: false, width:1000, height:500} );"><img src="klaspad/images/view.png" border="0" title="View"></a></td>
...
/*  <a href="index.php?route=klaspad/klaspad/fillintheblank_image_uploaded/'.$record['id'].'" target="_blank"  onclick="return hs.htmlExpand(this, { objectType: \'iframe\', preserveContent: false} );"  >
  <img src="klaspad/images/upload-icon.png" title="upload">
	...
	foreach($rec as $record){
	$ret.= '<tr id="'.$record['id'].'"><th>'.$i.'.&nbsp;&nbsp;&nbsp;&nbsp;</th><td>'.$record['uploadimage'].'</td><td>';
	$ret.= '</td></tr><tr><td><a href="index.php?route=klaspad/klaspad/add_files&moduleid='.$record['moduleid'].'&topicid='.$record['topicid'].'&headingid='.$record['headingid'].'&resourceid='.$record['id'].'&courseid='.$record['course_id'].'" onclick="return parent.hs.htmlExpand(this, { objectType: \'iframe\', preserveContent: false, width:1000, height:500} );"><img src="klaspad/images/view.png" border="0" title="View"></a></td>
	<td><a href="index.php?route=klaspad/klaspad/delete_resource&resourceid='.$record['id'].'"  onClick=document.getElementById(\''.$record['id'].'\').style.display=\'none\';  >
  <img src="klaspad/images/delete.png" title="Delete">
  </a>
...
/*  <a href="index.php?route=klaspad/klaspad/fillintheblank_image_uploaded/'.$record['id'].'" target="_blank"  onclick="return hs.htmlExpand(this, { objectType: \'iframe\', preserveContent: false} );"  >
  <img src="klaspad/images/upload-icon.png" title="upload">
	...
	$i=1;
	foreach($rec as $record){
	$ret.= '<tr id="'.$record['id'].'"><th>'.$i.'.&nbsp;&nbsp;&nbsp;&nbsp;</th><td>';
	if($record['excercises_video']!=''){
	$ret.= $record['excercises_video'];
	}else{
	$ret.= $record['excercises_audio'];	
	}
	$ret.= '</td><td>';
	$ret.= '</td></tr><tr><td><a href="index.php?route=klaspad/klaspad/add_video&moduleid='.$record['moduleid'].'&topicid='.$record['topicid'].'&headingid='.$record['headingid'].'&resourceid='.$record['id'].'&courseid='.$record['course_id'].'" onclick="return parent.hs.htmlExpand(this, { objectType: \'iframe\', preserveContent: false, width:1000, height:500} );"><img src="klaspad/images/view.png" border="0" title="View"></a></td>
	<td><a href="index.php?route=klaspad/klaspad/delete_resource&resourceid='.$record['id'].'"  onClick=document.getElementById(\''.$record['id'].'\').style.display=\'none\';  >
  <img src="klaspad/images/delete.png" title="Delete">
  </a>
...
/*  <a href="index.php?route=klaspad/klaspad/fillintheblank_image_uploaded/'.$record['id'].'" target="_blank"  onclick="return hs.htmlExpand(this, { objectType: \'iframe\', preserveContent: false} );"  >
  <img src="klaspad/images/upload-icon.png" title="upload">
	...
	$i=1;
	foreach($rec as $record){
	echo '<tr id="'.$record['id'].'"><th>'.$i.'.&nbsp;&nbsp;&nbsp;&nbsp;</th><td>'.$record['answere'].'</td><td>';
			if($record['uploadimage']!=''){
	echo '<img src="klaspad/uploads/'.$this->session->data['campusid'].'/'.$record['course_id'].'/exercise/'.$record['uploadimage'].'" width="17" >';
	}

	echo '</td><td><a href="index.php?route=klaspad/klaspad/add_assiement&moduleid='.$record['moduleid'].'&topicid='.$record['topicid'].'&headingid='.$record['headingid'].'&resourceidd='.$record['id'].'&courseid='.$record['course_id'].'" onclick="return parent.hs.htmlExpand(this, { objectType: \'iframe\', preserveContent: false, width:800, height:800} );"><img src="klaspad/images/view.png" border="0" title="View"></a></td>
...
<?php	}else{
	...
	echo '</td><td><a href="index.php?route=klaspad/klaspad/add_discussion&moduleid='.$record['moduleid'].'&topicid='.$record['topicid'].'&headingid='.$record['headingid'].'&resourceidd='.$record['id'].'&courseid='.$record['course_id'].'" onclick="return parent.hs.htmlExpand(this, { objectType: \'iframe\', preserveContent: false, width:800, height:800} );"><img src="klaspad/images/view.png" border="0" title="View"></a></td>
...
/*  <a href="index.php?route=klaspad/klaspad/fillintheblank_image_uploaded/'.$record['id'].'" target="_blank"  onclick="return hs.htmlExpand(this, { objectType: \'iframe\', preserveContent: false} );"  >
  <img src="klaspad/images/upload-icon.png" title="upload">
	...
	echo '</td><td><a href="index.php?route=klaspad/klaspad/add_descripting&moduleid='.$record['moduleid'].'&topicid='.$record['topicid'].'&headingid='.$record['headingid'].'&resourceidd='.$record['id'].'&courseid='.$record['course_id'].'" onclick="return parent.hs.htmlExpand(this, { objectType: \'iframe\', preserveContent: false, width:800, height:800} );"><img src="klaspad/images/view.png" border="0" title="View"></a></td>
...
<?php	}else{
	...
	if(@$_GET['sourcetype']=='direct'){		
	$this->redirect($this->url->https('klaspad/klaspad/add_crosswords&type='.@$_GET['type'].'&moduleid='.@$_GET['moduleid'].'&exerciseid='.@$id.'&courseid='.@$_GET['courseid'].'&topicid='.@$_POST['topic_id_id'].'&resourceid='.@$_POST['exercise_id_id'].'&sourcetype=direct&exehid='.@$_POST['topic_id']));				
	}else{
...
public function insert_crossword_excercises_2(){
	...
	//$this->redirect($this->url->https('klaspad/klaspad/add_fill_in_the_blank&type='.@$_GET['type'].'&moduleid='.@$_GET['moduleid'].'&courseid='.@$_GET['courseid'].'&topicid='.@$_GET['topicid'].'&resourceid='.@$_GET['resourceid'].'&sourcetype=direct&status=done'));
	if($_GET['sourcetype']=='direct'){	
	$this->redirect($this->url->https('klaspad/klaspad/mobile_module_activity&groupid='.$_POST['groupid'].'&type='.@$_GET['type'].'&moduleid='.@$_GET['moduleid'].'&courseid='.@$_GET['courseid'].'&topicid='.@$_GET['topicid'].'&resourceid='.@$_GET['resourceid'].'&sourcetype=direct&status=done&exehid='.@$_GET['exehid']));
	}else{
...
$totattmpt=$query2->rows;	
	...
	//echo "select ee.*,ea.id as favid from e_10_edu_excercises_fillintheblanks as ee left join e_10_edu_fav as ea on ee.id=ea.resourceid where topic_id='".$heading_data['id']."' ";	
...
//$answere=array();
//echo "select * from e_10_edu_result_descripting where did='".$exe_data['id']."' and user_id='".$this->session->data['userid']."'";	
...
//echo "select * from e_10_edu_answere_crossword where crossword_id='".$exedata['id']."'";
...
//echo "select * from e_10_edu_result_crossword where topic_id='".$_GET['headingid']."' and user_id='".$this->session->data['userid']."'  order by id DESC limit 0,5";
$this->data['totattmpt']=array();	
...
$totattmpt=$query2->rows;	
	...
	//echo "select id, rssfeedlink from e_10_edu_excercises where topic_id='".$_GET['headingid']."'";
	...
	//echo "select * from e_10_edu_excercises_discussion where resourceid='".$sqd['id']."' ";
...
//echo "select * from e_10_edu_excercises_assignment where resourceid='".$sqd['id']."'";
...
//echo "select c.*, h.headingname from e_10_edu_excercises_crossword as c left join e_10_edu_headings as h on c.topic_id=h.id where c.resourceid='".$sqd['id']."'";
...
//echo "select c.*, h.headingname from e_10_edu_excercises_fillintheblanks as c left join e_10_edu_headings as h on c.topic_id=h.id where c.resourceid='".$sqd['id']."' group by c.topic_id";
$query6=$this->db->query("select c.*, h.headingname from e_10_edu_excercises_fillintheblanks as c left join e_10_edu_headings as h on c.topic_id=h.id where c.resourceid='".$sqd['id']."' group by c.topic_id");	
$crswrd2=$query6->rows;
$this->data['fill']=array();	
//$this->data['crossword'][]=$crswrd;	
...
//echo "select c.*, h.headingname from e_10_edu_excercises_descripting as c left join e_10_edu_headings as h on c.topic_id=h.topic_id where c.resourceid='".$sqd['id']."' and h.exerciestype='Descripting' group by c.topic_id";
...
//$data=array('discussion'=>@$discussion);		
	...
	foreach($module_course_wise as $result)
		...
		$module_dataaa=$this->model_klaspad_klaspad->module_data();
	//echo '<pre>';
	//print_r($module_dataaa);		
	$this->data['course_idd']=$module_dataaa['course_id'];
	$this->data['modulenamee']=$module_dataaa['modulename'];
	$this->data['all_exe']=array();
	$all_exeee=$this->model_klaspad_klaspad->list_module();
	//echo '<pre>';
	//print_r($all_exeee);
	$intro_topicsss=$this->model_klaspad_klaspad->intro_topics();
	foreach($all_exeee as $all_exeee){
	$this->data['all_exe'][]=array(
			'id' => $all_exeee['id'],
            'topicname' => $all_exeee['topicname'],
            'module_id' => $all_exeee['module_id'],
            'numberofheadings' => $all_exeee['numberofheadings'],
            'topicno' => $all_exeee['topicno'],
            'description' => $all_exeee['description'],
            'learningoutcomes' => $all_exeee['learningoutcomes'],
            'exerciestype' => $all_exeee['exerciestype'],
            'introvideo' => $all_exeee['introvideo'],
            'modified_date' => $all_exeee['modified_date']
					);
	$this->data['exe_type'.$all_exeee['id']]=array();					
	${'exe_'.$all_exeee['id']}=$this->model_klaspad_klaspad->exercise_data($all_exeee['id']);
	//print_r(${'exe_'.$all_exe['id']}[1]);
	$description=${'exe_'.$all_exeee['id']}[0]['description'];
	foreach(${'exe_'.$all_exeee['id']}[1] as $exe_dta){
	$this->data['exe_type'.$all_exeee['id']][]=array(
			'id' => $exe_dta['id'],
...
public function add_multiple_choice_questions()
	...
	if($_GET['sourcetype']=='direct'){
		//echo 'A';
		//die;
	$this->template = 'klaspad/add_multiple_choice_questions_direct.php';	
	}else{
		//echo 'B';
		//die;
...
public function add_truefalse()
	...
	if($_GET['sourcetype']=='direct'){
		//echo 'A';
		//die;
	$this->template = 'klaspad/add_truefalse_direct.php';	
	}else{
		//echo 'B';
		//die;
...
public function insert_multiple_choice_questions()
	...
	if(@$_GET['sourcetype']=='direct'){		
	$this->redirect($this->url->https('klaspad/klaspad/add_multiple_choice_questions&type='.@$_GET['type'].'&moduleid='.@$_GET['moduleid'].'&courseid='.@$_GET['courseid'].'&topicid='.@$_POST['topic_id_id'].'&resourceid='.@$_POST['exercise_id_id'].'&sourcetype=direct&status=done&exehid='.@$_POST['topic_id']));				
	}
...
public function insert_truefalse()
	...
	if(@$_GET['sourcetype']=='direct'){		
	$this->redirect($this->url->https('klaspad/klaspad/add_truefalse&type='.@$_GET['type'].'&moduleid='.@$_GET['moduleid'].'&courseid='.@$_GET['courseid'].'&topicid='.@$_POST['topic_id_id'].'&resourceid='.@$_POST['exercise_id_id'].'&sourcetype=direct&status=done&exehid='.@$_POST['topic_id']));				
	}	
    //$this->session->set_flashdata('message', 'Added successfully');	?>
   	<script>
   	parent.window.hs.getExpander().close();
...
public function add_assiement()
	...
	$this->data['submissiondate']=$record['submissiondate'];
	$this->data['latesubmission']=$record['latesubmission'];
	$this->data['lastsubmissiondate']=$record['lastsubmissiondate'];
	$this->data['resubmission']=$record['resubmission'];
	$this->data['paidsubmission']=$record['paidsubmission'];
	$this->data['submissionfee']=$record['submissionfee'];
	...
	if($_GET['sourcetype']=='direct'){
		//echo 'A';
		//die;
	$this->template = 'klaspad/add_assiement_direct.php';	
	}else{
		//echo 'B';
		//die;
...
public function insert_assiement(){
	...
	if(@$_GET['sourcetype']=='direct'){		
	$this->redirect($this->url->https('klaspad/klaspad/add_assiement&type='.@$_GET['type'].'&moduleid='.@$_GET['moduleid'].'&courseid='.@$_GET['courseid'].'&topicid='.@$_POST['topic_id_id'].'&resourceid='.@$_POST['exercise_id_id'].'&sourcetype=direct&status=done&exehid='.@$_POST['topic_id']));				
	}	
...
public function add_discussion()
	...
	$this->id       = 'content';
	if($_GET['sourcetype']=='direct'){
	$this->template = 'klaspad/add_discussion_direct.php';		
	}else{
...
public function add_descripting()
	...
	if(@$_GET['sourcetype']=='direct'){
		////echo 'A';
		//die;
	$this->template = 'klaspad/add_descripting_direct.php';
	}else{
		//echo 'B';
		//die;
...
public function insert_discussion(){
	...
	if(@$_GET['sourcetype']=='direct'){		
	$this->redirect($this->url->https('klaspad/klaspad/add_discussion&type='.@$_GET['type'].'&moduleid='.@$_GET['moduleid'].'&courseid='.@$_GET['courseid'].'&topicid='.@$_POST['topic_id_id'].'&resourceid='.@$_POST['exercise_id_id'].'&sourcetype=direct&status=done&exehid='.@$_POST['topic_id']));				
	}
    //$this->session->set_flashdata('message', 'Add successfully');	
?>
   <script>
...
public function insert_descripting(){
    ...
    //$this->session->set_flashdata('message', 'Add successfully');	
	if(@$_GET['sourcetype']=='direct'){		
	$this->redirect($this->url->https('klaspad/klaspad/add_descripting&type='.@$_GET['type'].'&moduleid='.@$_GET['moduleid'].'&courseid='.@$_GET['courseid'].'&topicid='.@$_POST['topic_id_id'].'&resourceid='.@$_POST['exercise_id_id'].'&sourcetype=direct&status=done&exehid='.@$_POST['topic_id']));				
	}/*else{
	$this->redirect($this->url->https('klaspad/klaspad/add_descripting&type='.@$_GET['type'].'&moduleid='.@$_GET['moduleid'].'&exerciseid='.@$id));					
	}*/
?>
   <script>
   parent.window.hs.getExpander().close();
...
public function add_powerpoint_exercise()
	...
	$this->id       = 'content';
	if($_GET['sourcetype']=='direct'){
	$this->template = 'klaspad/add_powerpoint_exercise_direct.php';
	}else{
...
public function add_files()
	...
	$this->id       = 'content';
	if($_GET['sourcetype']=='direct'){
	$this->template = 'klaspad/add_files_direct.php';
	}else{
...
public function add_video()
	...
	$this->id       = 'content';
	if($_GET['sourcetype']=='direct'){
	$this->template = 'klaspad/add_videos_direct.php';
	}else{
...
$vv= $script."/cloudfiles/resourcevideoupload.php?sourcetype=direct&campus=".$this->session->data['campusid']."&id=".$course_id."&filepathimage=".$filepathimage."&filename=".$name."&resid=".$insertid."&collegeId=".$cols['collegeId']."&topicid=".$_POST['topic_id_id']."&headingid=".$_POST['topic_id']."&moduleid=".$_GET['moduleid']."&courseid=".$course['course_id'];
...
public function mobile_login()
	...
	$this->db->query("insert into `logindetails` 
				SET 
				    ...
				    logindate=now()
		");
	$status=array('data'=>@$count[1],'status'=>'true','studentid'=>'','staffid'=>$ssq['staffid'],'studentstatus'=>'','staffstatus'=>$ssq['status'],'sessionid'=>$this->session->data['id']);
    echo json_encode($status);
	}else{
	$message='Username/Password Is Incorrect';	
	$status=array('data'=>'no data','status'=>'false','message'=>$message);		
...
public function exercise_courses_details(){
	...
	if(@$_GET['topicid']!=''){
	$_POST['topicid']=$_GET['topicid'];	
	}
	if(@$_GET['heading_id']!=''){
	$_POST['heading_id']=$_GET['heading_id'];	
	}
	if(@$_GET['user_id']!=''){
...
$query211=$this->db->query("select * from e_".$_POST['connectionid']."_edu_result_draganddrop where topic_id='".$_POST['topicid']."' and user_id='".$_POST['user_id']."' and connect_id='".$_POST['connectionid']."' order by id desc limit 0,5");
...
$query211t=$this->db->query("select * from e_".$_POST['connectionid']."_edu_result_draganddrop where topic_id='".$_POST['topicid']."' and user_id='".$_POST['user_id']."' and connect_id='".$_POST['connectionid']."' order by id desc");
...
$totattmptt[]=array(
	...
	}else if(@$_POST['exerciestype']=='Descripting' || @$_POST['exerciestype']=='descripting'){
...
$alldata[]=array('id'=>$exedata['id'],
	...
	//echo "select * from e_".$s['connectionid']."_edu_result_fillintheblanks where topic_id='".$_POST['topicid']."' and user_id='".$_POST['user_id']."' and connect_id='".$_POST['connectionid']."' order by id desc limit 0,5";
$query2=$this->db->query("select * from e_".$s['connectionid']."_edu_result_fillintheblanks where topic_id='".$_POST['topicid']."' and user_id='".$_POST['user_id']."' and connect_id='".$_POST['connectionid']."' order by id desc limit 0,5");
...
$query2t=$this->db->query("select * from e_".$s['connectionid']."_edu_result_fillintheblanks where topic_id='".$_POST['topicid']."' and user_id='".$_POST['user_id']."' and connect_id='".$_POST['connectionid']."' order by id desc");
$totattmpt1t=$query2t->rows;
foreach($totattmpt1t as $tot1){
$totattmptt[]=array(
			'id' => $tot1['id'],
            'course_id' => $tot1['course_id'],
            'module_id' => $tot1['module_id'],
            'topic_id' => $tot1['topic_id'],
            'heading_id' => $tot1['heading_id'],
            'total_question' => $tot1['total_question'],
			'correct_question' => $tot1['correct_question'],
			'worng_question' => $tot1['worng_question'],
            'done_date' => $tot1['done_date'],
            'user_id' => $tot1['user_id'],
            'connect_id' => $tot1['connect_id']
			);	
}
}else if(@$_POST['exerciestype']=='TrueFalse'){	
...
$query2=$this->db->query("select * from e_".$s['connectionid']."_edu_result_truefalse where topic_id='".$_POST['topicid']."' and user_id='".$_POST['user_id']."' and connect_id='".$_POST['connectionid']."' order by id desc limit 0,5");
$totattmpt1=$query2->rows;
foreach($totattmpt1 as $tot){
$totattmpt[]=array(
			'id' => $tot['id'],
...
$query2t=$this->db->query("select * from e_".$s['connectionid']."_edu_result_truefalse where topic_id='".$_POST['topicid']."' and user_id='".$_POST['user_id']."' and connect_id='".$_POST['connectionid']."' order by id desc");
$totattmpt1t=$query2t->rows;
foreach($totattmpt1t as $tot){
$totattmptt[]=array(
			'id' => $tot['id'],
...
$query3=$this->db->query("select * from e_".$s['connectionid']."_edu_result_crossword where topic_id='".$_POST['topicid']."' and user_id='".$_POST['user_id']."' and connect_id='".$_POST['connectionid']."' order by id desc limit 0,5");
...
$query3t=$this->db->query("select * from e_".$s['connectionid']."_edu_result_crossword where topic_id='".$_POST['topicid']."' and user_id='".$_POST['user_id']."' and connect_id='".$_POST['connectionid']."' order by id desc");
...
mysql_query("insert into e_".$s['connectionid']."_edu_result set course_id='".$_POST['courseid']."', module_id='".$_POST['mid']."', topic_id='".$_POST['topicid']."', heading_id='".$_POST['heading_id']."', total_question='".$_POST['total_question']."', correct_question='".$_POST['correct_question']."', worng_question='".$_POST['worng_question']."', done_date=now(), user_id='".$_POST['user_id']."', connect_id='".$_POST['connect_id']."'");
	$this->redirect($this->url->https('klaspad/klaspad/exercise_courses_details&courseid='.$_POST['courseid'].'&exerciseid='.$_POST['exerciseid'].'&topicid='.$_POST['topicid'].'&heading_id='.$_POST['heading_id'].'&user_id='.$_POST['user_id'].'&connect_id='.$_POST['connect_id'].'&exerciestype='.$extype));	
}
...
mysql_query("insert into e_".$s['connectionid']."_edu_result_fillintheblanks set course_id='".$_POST['courseid']."', module_id='".$_POST['mid']."', topic_id='".$_POST['topicid']."', heading_id='".$_POST['heading_id']."', total_question='".$_POST['total_question']."', correct_question='".$_POST['correct_question']."', worng_question='".$_POST['worng_question']."', done_date=now(), user_id='".$_POST['user_id']."', connect_id='".$_POST['connect_id']."'");
	$this->redirect($this->url->https('klaspad/klaspad/exercise_courses_details&courseid='.$_POST['courseid'].'&exerciseid='.$_POST['exerciseid'].'&heading_id='.$_POST['heading_id'].'&user_id='.$_POST['user_id'].'&connect_id='.$_POST['connect_id'].'&exerciestype='.$extype.'&topicid='.$_POST['topicid']));	
}
...
mysql_query("insert into e_".$s['connectionid']."_edu_result_crossword set course_id='".$_POST['courseid']."', module_id='".$_POST['mid']."', topic_id='".$_POST['topicid']."', heading_id='".$_POST['heading_id']."', result='".$_POST['result']."', done_date=now(), user_id='".$_POST['user_id']."', connect_id='".$_POST['connect_id']."'");
	$this->redirect($this->url->https('klaspad/klaspad/exercise_courses_details&courseid='.$_POST['courseid'].'&exerciseid='.$_POST['exerciseid'].'&heading_id='.$_POST['heading_id'].'&user_id='.$_POST['user_id'].'&connect_id='.$_POST['connect_id'].'&exerciestype='.$_POST['exerciestype'].'&topicid='.$_POST['topicid']));	
}	
...
$answere[]=$dat;
	...
	if(!empty($answere)){
		//echo "select * from e_".$s['connectionid']."_edu_result_crossword where topic_id='".$id."' and user_id='".$_POST['user_id']."' and connect_id='".$_POST['connectid']."' and user_id='".$_POST['user_id']."' order by id desc limit 0,5";
$query4	=$this->db->query("select * from e_".$s['connectionid']."_edu_result_crossword where topic_id='".$id."' and user_id='".$_POST['user_id']."' and connect_id='".$_POST['connectid']."' and user_id='".$_POST['user_id']."' order by id desc limit 0,5");
$crossresultt=$query4->rows;
foreach($crossresultt as $ddresultt){
$crossresult[]=array(
'id'=>$ddresultt['id'],
'course_id'=>$ddresultt['course_id'],
'module_id'=>$ddresultt['module_id'],
'topic_id'=>$ddresultt['topic_id'],
'heading_id'=>$ddresultt['heading_id'],
'result'=>$ddresultt['result'],
'done_date'=>$ddresultt['done_date'],
'user_id'=>$ddresultt['user_id'],
'connect_id'=>$ddresultt['connect_id']
	);
}
	}
...
$fill[]=$dat;
	...
	if(!empty($fill)){
$query4=$this->db->query("select * from e_".$s['connectionid']."_edu_result where total_question !='0' and topic_id='".$id."' and connect_id='".$_POST['connectid']."' and user_id='".$_POST['user_id']."' order by id DESC limit 0,5");
$multiresultt=$query4->rows;
foreach($multiresultt as $ddresultt){
$multiresult[]=array(
'id'=>$ddresultt['id'],
'course_id'=>$ddresultt['course_id'],
'module_id'=>$ddresultt['module_id'],
'topic_id'=>$ddresultt['topic_id'],
'heading_id'=>$ddresultt['heading_id'],
'total_question'=>$ddresultt['total_question'],
'correct_question'=>$ddresultt['correct_question'],
'worng_question'=>$ddresultt['worng_question'],
'done_date'=>$ddresultt['done_date'],
'user_id'=>$ddresultt['user_id'],
'connect_id'=>$ddresultt['connect_id']
	);
...
$trfl[]=$dat;
	...
	if(!empty($trfl)){
$query4=$this->db->query("select * from e_".$s['connectionid']."_edu_result_truefalse where total_question !='0' and topic_id='".$id."' and connect_id='".$_POST['connectid']."' and user_id='".$_POST['user_id']."' order by id DESC limit 0,5");
$trflresultt=$query4->rows;
foreach($trflresultt as $ddresultt){
$trflresult[]=array(
'id'=>$ddresultt['id'],
'course_id'=>$ddresultt['course_id'],
'module_id'=>$ddresultt['module_id'],
...
$filll[]=$dat;
	...
	if(!empty($filll)){
$query4=$this->db->query("select * from e_".$s['connectionid']."_edu_result_fillintheblanks where total_question !='0' and topic_id='".$id."' and connect_id='".$_POST['connectid']."' and user_id='".$_POST['user_id']."' order by id DESC limit 0,5");
$fillresultt=$query4->rows;
foreach($fillresultt as $ddresultt){
$fillresult[]=array(
'id'=>$ddresultt['id'],
'course_id'=>$ddresultt['course_id'],
'module_id'=>$ddresultt['module_id'],
...
'connect_id'=>$ddresultt['connect_id']
	...
	//echo "select * from e_".$s['connectionid']."_edu_excercises_draganddrop where topic_id='".$heading_data['id']."' and exerciestype='Write in the correct box' and resourceid='".$_POST['resourceid']."'<br />";
...
$datw['path']='klaspad/uploads/'.$s['connectionid'].'/'.$_POST['course_id'].'/exercise/';
$datw['courseid']=$_POST['course_id'];
$datw['coursename']=$s['coursename'];
$datw['moduleid']=$iddd;
$datw['headingid']=$res_data['headid'];
//$dat['resourceid']=$heading_data['id'];
$datw['resourcename']=$res_data['headingname'];
$datw['exercisename_multi']=$heading_data['headingname'];
$datw['blockdata']=$blockdataa;
//print_r($hnt);
$draganddrop[]=$datw;
/*$draganddrop[]=array(
'path'=>'klaspad/uploads/'.$s['connectionid'].'/'.$_POST['course_id'].'/exercise/',
'courseid'=>$_POST['course_id'],
'coursename'=>$s['coursename'],
'moduleid'=>$iddd,
'headingid'=>$res_data['headid'],
'resourcename'=>$res_data['headingname'],
'exercisename_multi'=>$heading_data['headingname'],
'blockdata'=>$blockdataa
	);*/
	}
	...
	//if(!empty($draganddrop)){
		//echo "select * from e_".$s['connectionid']."_edu_result_draganddrop where total_question !='0' and topic_id='".$id."' and connect_id='".$_POST['connectid']."' and user_id='".$_POST['user_id']."' order by id DESC limit 0,5";
$query4444=$this->db->query("select * from e_".$s['connectionid']."_edu_result_draganddrop where total_question !='0' and topic_id='".$id."' and connect_id='".$_POST['connectid']."' and user_id='".$_POST['user_id']."' order by id DESC limit 0,5");
$ddresultt=$query4444->rows;
foreach($ddresultt as $ddresultt){
$ddresult[]=array(
'id'=>$ddresultt['id'],
'course_id'=>$ddresultt['course_id'],
'module_id'=>$ddresultt['module_id'],
...
public function getcoutsedetails_new()
	{
		$this->load->model('klaspad/klaspad');
	if(isset($this->session->data['userid'])){
	$query=$this->db->query("select * from e_".$this->session->data['campusid']."_edu_courses where id='".$_GET['courseid']."'");	
	...
	$queryyy= $this->db->query("select id,modulename,moduletype from e_".$this->session->data['campusid']."_edu_modules where course_id='".$_GET['courseid']."' order by id asc");
	$module_course_wise=$queryyy->rows;				
	//$module_course_wise=$this->model_klaspad_klaspad->module_course_wise($_GET['courseid']);
	//echo '<pre>';
	//print_r(${'module'.$course['id']});
	foreach($module_course_wise as $result){
			$query= $this->db->query("select * from e_".$this->session->data['campusid']."_edu_topics where module_id='".$result['id']."'  order by shortorder asc ");	
	
	$all_exeee= $query->rows;
	//$this->data['all_exe']=array();
	//$all_exeee=$this->model_klaspad_klaspad->list_module();
	//echo '<pre>';
	//print_r($all_exe);
	...
	foreach($all_exeee as $all_exeee){
		if($zz==1){
			$topic_id=$all_exeee['id'];
		}else{
			$topic_id=$topic_id.','.$all_exeee['id'];
		}
	$zz++;}
	$this->data['resource']=array();			
	$query1= $this->db->query("select headingname,id,exerciestype, topic_id from e_".$this->session->data['campusid']."_edu_headings where topic_id in (".$topic_id.") order by shortorder asc");		
	$mm1=$query1->rows;
	foreach($mm1 as $exe_dta){
	$this->data['resource'][]=array(
			'id' => $exe_dta['id'],
            'headingname' => $exe_dta['headingname'],
            'exerciestype' => $exe_dta['exerciestype'],
			'topicid' => $exe_dta['topic_id']
					);
	}		
				   $this->data['module_course_wise'][]=array(
					'id'=>$result['id'],
	...
	$this->data['learningoutcomes']=$mm['learningoutcomes'];
	$this->data['videoupload']=$mm['videoupload'];
	$this->data['CourseLeader']=$mm['CourseLeader'];
	$this->id       = 'content';
		$this->template = 'klaspad/getcoursedetails_new.php';
		//$this->layout   = 'module/layout';
		$this->render();		
	//$this->load->view('welcome/dash_board');
	}else{
...
public function attempt() {
		...
		$module=array();
	$userq=$this->db->query("select userid from user where studentID='".$_POST['preukid']."'");	
	$users=$userq->row;	
			
	$modq=$this->db->query("select distinct moduleid from academicsessionstudent where studentid='".$_POST['preukid']."'");	
	$mods=$modq->rows;	
	...
	//$id=$_POST['topicid'];
	//$str=" and id='".$id."' ";$str	
	$query2= $this->db->query("select * from e_".$_POST['connectionid']."_edu_topics where module_id='".$mods['moduleid']."'  ");	
	...
	$id111=$_GET['moduleid'];
	$query3= $this->db->query("select headingname,id,exerciestype from e_".$_POST['connectionid']."_edu_headings where topic_id='".$all_exe['id']."' and exerciestype in ('Write in the correct box','Descripting','Fill in the blanks','TrueFalse','Multiple choice questions','Crosswords') order by id asc ");		
	$mm=$query3->rows;
	$sstrr='';
	...
	if(@$exe_dta['exerciestype']=='Write in the correct box' || @$exe_dta['exerciestype']=='Writeinthecorrectbox'){
	$exeq=mysql_query("select id from e_".$_POST['connectionid']."_edu_excercises_draganddrop where topic_id='".$exe_dta['id']."'");
	$exes=mysql_fetch_array($exeq);
	}else if(@$exe_dta['exerciestype']=='Descripting' || @$exe_dta['exerciestype']=='descripting'){
	$exeq=mysql_query("select id from e_".$_POST['connectionid']."_edu_excercises_descripting where topic_id='".$exe_dta['id']."'");
	$exes=mysql_fetch_array($exeq);
	}else if(@$exe_dta['exerciestype']=='Fill in the blanks' || @$exe_dta['exerciestype']=='Fillintheblanks'){
	$exeq=mysql_query("select id from e_".$_POST['connectionid']."_edu_excercises_fillintheblanks where topic_id='".$exe_dta['id']."'");
	$exes=mysql_fetch_array($exeq);
	}else if(@$exe_dta['exerciestype']=='TrueFalse'){
	$exeq=mysql_query("select id from e_".$_POST['connectionid']."_edu_excercises_truefalse where topic_id='".$exe_dta['id']."'");
	$exes=mysql_fetch_array($exeq);
	}else if(@$exe_dta['exerciestype']=='Multiple choice questions' || @$exe_dta['exerciestype']=='Multiplechoicequestions'){
	$exeq=mysql_query("select id from e_".$_POST['connectionid']."_edu_excercises_multiplechoice where topic_id='".$exe_dta['id']."'");
	$exes=mysql_fetch_array($exeq);
	}else if(@$exe_dta['exerciestype']=='Crosswords'){
	$exeq=mysql_query("select id from e_".$_POST['connectionid']."_edu_excercises_crossword where topic_id='".$exe_dta['id']."'");
	$exes=mysql_fetch_array($exeq);
	}else{
	$exeq=mysql_query("select id from e_".$_POST['connectionid']."_edu_excercises where topic_id='".$exe_dta['id']."'");
	$exes=mysql_fetch_array($exeq);
	}	
	...
	$data=array( 'data'=>$module);
echo json_encode($data);
        
      } 

public function conference(){
$q=$this->db->query("select *, c.id as id from conferenceschedule c inner join conferenceassignment as ca on ca.conferenceid=c.id where conferencedate>='".date('Y-m-d')."' and studentid='".$_POST['studentid']."'");
$s=$q->rows;
$con=array();
				foreach($s as $s){
				$con[]=array(
            ...
            'token' => $s['token'],
			'sessionid_sc' => $s['sessionid_sc'],
            'token_sc' => $s['token_sc'],
			'conferencedate'=>$s['conferencedate'],
			'fromtime'=>$s['fromhh'].':'.$s['frommm'],
			'totime'=>$s['tohh'].':'.$s['tomm']
					);	

				}

$q1=$this->db->query("select *, c.id as id from chatschedule c inner join chatassignment as ca on ca.chatid=c.id where chatdate>='".date('Y-m-d')."' and studentid='".$_POST['studentid']."'");
$s1=$q1->rows;
$con1=array();
				foreach($s1 as $s1){
				$con1[]=array(
            ...
            'description' => $s1['description'],
            'heading' => $s1['heading'],
            'chatdate'=>$s1['chatdate'],
			'fromtime'=>$s1['fromhh'].':'.$s1['frommm'],
			'totime'=>$s1['tohh'].':'.$s1['tomm']
					);	

				}
				
$q2=$this->db->query("select *, c.id as id from phonecallschedule c inner join phonecallassignment as ca on ca.phonecallid=c.id where phonecalldate>='".date('Y-m-d')."' and studentid='".$_POST['studentid']."'");
$s2=$q2->rows;
$stsq=mysql_query("select phoneno from student where preukid='".$_POST['studentid']."'");
$stss=mysql_fetch_array($stsq);
$con2=array();
				foreach($s2 as $s2){
	$stfq=mysql_query("select PhoneNo from staff where staffid='".$s2['staffid']."'");
	$stfs=mysql_fetch_array($stfq);				
				$con2[]=array(
			'id' => $s2['id'],
            'description' => $s2['description'],
            'heading' => $s2['heading'],
            'phonecalldate'=>$s2['phonecalldate'],
			'fromtime'=>$s2['fromhh'].':'.$s2['frommm'],
			'studentphoneno'=>$stss['phoneno'],
			'staffphoneno'=>$stfs['PhoneNo']
					);	

				}
				
				
$q3=$this->db->query("select *, c.id as id from whiteboardschedule c inner join whiteboardassignment as ca on ca.whiteboardid=c.id where whiteboarddate>='".date('Y-m-d')."' and studentid='".$_POST['studentid']."'");
$s3=$q3->rows;
$con3=array();
				foreach($s3 as $s3){
			$con3[]=array(
            ...
            'token' => $s3['token'],
			'whiteboarddate'=>$s3['whiteboarddate'],
			'fromtime'=>$s3['fromhh'].':'.$s3['frommm'],
			'totime'=>$s3['tohh'].':'.$s3['tomm']
					);

				}				
								
$q5=$this->db->query("select * from studentfeedack where studentid='".$_POST['studentid']."'");
$s5=$q5->rows;
$con5=array();
				foreach($s5 as $s5){
			$con5[]=array(
...
$q6=$this->db->query("select *, c.id as id from noticeschedule c inner join noticeassignment as ca on ca.noticeid=c.id where studentid='".$_POST['studentid']."'");
$s6=$q6->rows;
$con6=array();
				foreach($s6 as $s6){
			$con6[]=array(
...
$q4=$this->db->query("select * from requestconference where studentid='".$_POST['studentid']."'");
$s4=$q4->rows;
$con4=array();
				foreach($s4 as $s4){
					$stfq=mysql_query("select staffname, surname from staff where staffid='".$s4['staffid']."'");
					$stfs=mysql_fetch_array($stfq);
					if($s4['status']==1){
						$sts='Scheduled';
					}else{
				...
				$con4[]=array(
			'requestconferenceid' => $s4['requestconferenceid'],
            'message' => $s4['message'],
            'request' => $s4['request'],
            'requestconferencedate' => $s4['requestconferencedate'],
			'postdate'=>$s4['createddate'],
			'staff'=>$stfs['staffname'].' '.$stfs['surname'],
            'status' => $sts
					);	

				}				
$data=array( 'conference'=>$con,'chat'=>$con1,'phonecall'=>$con2,'whiteboard'=>$con3,'feedback'=>$con5,'notice'=>$con6,'request'=>$con4);
echo json_encode($data);				
...
public function add_fill_in_the_blank()
	...
	$this->id       = 'content';
	if(@$_GET['sourcetype']=='direct'){
	$this->template = 'klaspad/fill_in_the_blank_direct.php';
	}else{
...
public function insert_excercises()
	...
	if(@$_GET['sourcetype']=='direct'){		
	$this->redirect($this->url->https('klaspad/klaspad/write_in_the_correct_box&type='.@$_GET['type'].'&moduleid='.@$_GET['moduleid'].'&exerciseid='.@$id.'&courseid='.@$_GET['courseid'].'&topicid='.@$_POST['topic_id_id'].'&resourceid='.@$_POST['exercise_id_id'].'&sourcetype=direct&exehid='.@$_POST['topic_id']));				
	}else{
	...
	$id=$this->model_klaspad_klaspad->insert_excercises();
	if(@$_GET['sourcetype']=='direct'){		
	$this->redirect($this->url->https('klaspad/klaspad/add_fill_in_the_blank&type='.@$_GET['type'].'&moduleid='.@$_GET['moduleid'].'&exerciseid='.@$id.'&courseid='.@$_GET['courseid'].'&topicid='.@$_POST['topic_id_id'].'&resourceid='.@$_POST['exercise_id_id'].'&sourcetype=direct&exehid='.@$_POST['topic_id']));				
	}else{
...
public function insert_excercises_step_2()
    ...
    //$this->session->set_flashdata('message', 'Excercise added successfully');
	if($_GET['sourcetype']=='direct'){
	$this->redirect($this->url->https('klaspad/klaspad/add_fill_in_the_blank&type='.@$_GET['type'].'&moduleid='.@$_GET['moduleid'].'&courseid='.@$_GET['courseid'].'&topicid='.@$_GET['topicid'].'&resourceid='.@$_GET['resourceid'].'&sourcetype=direct&status=done&exehid='.@$_GET['exehid']));	
	}
	?>
   <script>
   parent.window.hs.getExpander().close();
...
public function add_write_in_the_correct_box()
	...
	$this->id       = 'content';
	if($_GET['sourcetype']=='direct'){
	$this->template = 'klaspad/write_in_the_correct_box_direct.php';
	}else{
...
public function write_in_the_correct_box_insert()
    ...
    //$this->session->set_flashdata('message', 'Excercise added successfully');
	if($_GET['sourcetype']=='direct'){
	$this->redirect($this->url->https('klaspad/klaspad/add_write_in_the_correct_box&type='.@$_GET['type'].'&moduleid='.@$_GET['moduleid'].'&courseid='.@$_GET['courseid'].'&topicid='.@$_GET['topicid'].'&resourceid='.@$_GET['resourceid'].'&sourcetype=direct&status=done&exehid='.@$_GET['exehid']));	
	}
	?>
   <script>
   parent.window.hs.getExpander().close();
...
public function assignmentdetails()
	{
	$q=mysql_query("select question,submissiondate,latesubmission,lastsubmissiondate,resubmission,paidsubmission,submissionfee from e_".$this->session->data['campusid']."_edu_excercises_assignment where id='".$_GET['id']."'");
	$s=mysql_fetch_array($q);
	...
	$this->data['paidsubmission'] = $s['paidsubmission'];
	$this->data['submissionfee'] = $s['submissionfee'];
	$this->id       = 'content';
...
$mn=1;
 ...
 $stuserid=0;
 $ntm=1;
 $dq=mysql_query("select studentID, staffID from user where userid='".$_POST['userid']."'");
 $ds=mysql_fetch_array($dq);
 if($ds['studentID']!='' && $ds['studentID']!=0){
	 $cq=mysql_query("select distinct courseid from studentintakecourse where studentid='".$ds['studentID']."'");
	 while($cs=mysql_fetch_array($cq)){
		 if($mn==1){
			$crsid=$cs['courseid']; 
		 }else{
			$crsid=$crsid.','.$cs['courseid']; 
		 }
	 $mn++;}
	 $sq=mysql_query("select distinct studentid from studentintakecourse where courseid in (".$crsid.")");
	 while($ss=mysql_fetch_array($sq)){
		 $uq=mysql_query("select userid from user where studentID='".$ss['studentid']."'");
		 $us=mysql_fetch_array($uq);
		 if($nm==1){
			 $suserid=$us['userid'];
		 }else{
			 $suserid=$suserid.','.$us['userid'];
		 }
	 $nm++;}
	 $stq=mysql_query("select distinct staffid from assignedstaffcourse where courseid in (".$crsid.")");
	 while($sts=mysql_fetch_array($stq)){
		 $utq=mysql_query("select userid from user where staffID='".$sts['staffid']."'");
		 $uts=mysql_fetch_array($utq);
		 if($ntm==1){
			 $stuserid=$uts['userid'];
		 }else{
			 $stuserid=$stuserid.','.$uts['userid'];
		 }
	 $ntm++;}
	 $alluserid=$_POST['userid'].','.$suserid.','.$stuserid;
 }else if($ds['staffID']!='' && $ds['staffID']!=0){
	 //echo "select distinct courseid from assignedstaffcourse where staffid='".$ds['staffID']."'<br />";
 	 $cq=mysql_query("select distinct courseid from assignedstaffcourse where staffid='".$ds['staffID']."' and courseid!=0");
	 while($cs=mysql_fetch_array($cq)){
		 if($mn==1){
			$crsid=$cs['courseid']; 
		 }else{
	 ...
	 $mn++;}
	 //echo "select distinct staffid from assignedstaffcourse where courseid in (".$crsid.")<br />";
	 $sq=mysql_query("select distinct staffid from assignedstaffcourse where courseid in (".$crsid.") and staffid!=0");
	 while($ss=mysql_fetch_array($sq)){
		 $uq=mysql_query("select userid from user where staffID='".$ss['staffid']."'");
		 $us=mysql_fetch_array($uq);
		 if($nm==1){
			 $suserid=$us['userid'];
		 }else{
	 ...
	 $nm++;}
	 //echo $suserid.'<br />';
	 //echo "select distinct studentid from studentintakecourse where courseid in (".$crsid.")<br />";
	 $stq=mysql_query("select distinct studentid from studentintakecourse where courseid in (".$crsid.") and studentid!=0");
	 while($sts=mysql_fetch_array($stq)){
		 $utq=mysql_query("select userid from user where studentID='".$sts['studentid']."'");
		 $uts=mysql_fetch_array($utq);
		 $ddcnt=mysql_num_rows($utq);
		 if($ddcnt>0){
		 if($ntm==1){
			 $stuserid=$uts['userid'];
		 }else{
 ...
 $z=1;
 //echo "select * from dash_post where userid in (".$alluserid.") order by createddate desc <br />";
// $postq=mysql_query("select * from dash_post where userid in (".$alluserid.") order by createddate desc");	
//	$z=1;
 $pq=$this->db->query("select * from dash_post where userid in (".$alluserid.") order by createddate desc");
 $postq=$pq->rows;
 $post=array();
...
public function insertimagevideopost(){
	...
	$uploaddir ='uploaded/postimage/'; 
		...
		$imgname=$time.basename($_FILES['uploadfile']['name']);
	}else{
	$uploaddir ='uploaded/postvideo/'; 
		$file = $uploaddir . $time.basename($_FILES['uploadfile']['name']);
		$f= $_FILES['uploadfile']['name'];
		move_uploaded_file($_FILES['uploadfile']['tmp_name'], $file);	
		$videoname=$time.basename($_FILES['uploadfile']['name']);
	}
...
$query = $this->db->query("SELECT * from tbl_department where id in (select distinct department_id from e_10_edu_courses where statuss='1')");
...
$t=$this->db->query("select * from e_".$_POST['connectionid']."_edu_courses where department_id='".$_POST['departmentid']."' and statuss='1'");
$topic=$t->rows;
$course=array();
foreach($topic as $tp){
...
$query=mysql_query("select * from package where courseid='".$tp['id']."' and pamt!=0");
$cntp=mysql_num_rows($query);
if($cntp>0){
	$fee='Paid';
}else{
	$fee='Free';
...
$course[]=array(
 ...
 'learningoutcomes'=>@$tp['learningoutcomes'],
 'videoupload'=>@$tp['videoupload'],
 'module' => $module,
 'feetype'=>$fee
 );	
}
...
$discussion=array();	
foreach($disc as $dis){
$que=$this->db->query('select ea.id as commid, ea.assignment, ea.connectionid, ea.user_id, ea.createddate from e_'.$s['connectionid'].'_edu_ans_assignment ea where ea.assignment_id="'.$dis['id'].'" order by ea.id desc');		
$mmk = $que->rows;	
$url1=array();
foreach($mmk as $mmkk){
$msq=mysql_query("select eu.user_image, eu.demo_contact_person from e_".$mmkk['connectionid']."_edu_user as eu where eu.id='".$mmkk['user_id']."'");	
...
//echo $userid;
echo $_SESSION['userid']=$_GET['userid'];	
$this->id       = 'content';
	$this->template = 'klaspad/cometchat.php';
	$this->render();	
...
//include_once ('cometchat/cometchat_init.php');
//sendMessageTo('74',"Would you like to have a Pizza?");
...
public function getPackage()
	{
		// print_r($_POST); die;
		$query=$this->db->query("select * from package where courseid='".$_POST['courseid']."'");
        $pac_info= $query->rows;
		foreach($pac_info as $pac_info)
		{
			$coursepackage[]=array(
			'id' => $pac_info['id'],
			'amount' => $pac_info['amount'],
			'pamt' => $pac_info['pamt'],
			'description'=>$pac_info['description']
			);
		} 
		
//$data=array('contact'=>$requestconference);		 
$data=array('coursepackage'=>$coursepackage);
echo json_encode($data);
exit;		 
    }


public function resultsinc(){
	//echo '<pre>';
	//print_r($_POST['result']);
	//die;
	//$json_array = (array)(json_decode($jsonData));
	//$jsonData = '{"fillintheblankresult":[{"correct_question":"4","done_date":"2014-06-23 18:20:30","module_id":"61","connect_id":"10","total_question":"4","course_id":"61","topic_id":"0","worng_question":"0","heading_id":"170"},{"correct_question":"2","done_date":"2014-06-23 18:21:09","module_id":"61","connect_id":"10","total_question":"4","course_id":"61","topic_id":"0","worng_question":"2","heading_id":"170"},{"correct_question":"0","done_date":"2014-06-23 18:21:51","module_id":"61","connect_id":"10","total_question":"4","course_id":"61","topic_id":"0","worng_question":"4","heading_id":"170"},{"correct_question":"0","done_date":"2014-06-23 18:25:45","module_id":"61","connect_id":"10","total_question":"4","course_id":"61","topic_id":"0","worng_question":"4","heading_id":"170"},{"correct_question":"2","done_date":"2014-06-23 18:35:59","module_id":"61","connect_id":"10","total_question":"4","course_id":"61","topic_id":"0","worng_question":"2","heading_id":"170"}],"crosswordresult":[],"truefalseresult":[{"correct_question":"0","done_date":"2014-06-23 18:11:22","module_id":"61","connect_id":"10","total_question":"2","course_id":"61","topic_id":"0","worng_question":"2","heading_id":"170"}],"multiresult":[],"dragdropresult":[{"correct_question":"0","done_date":"2014-06-23 18:11:22","module_id":"61","connect_id":"10","total_question":"2","course_id":"61","topic_id":"0","worng_question":"2","heading_id":"170"}]}';
	//$obj = (array)(json_decode($jsonData));
	$obj = (array)(json_decode($_POST['result']));
	//echo '<pre>';
	//print_r($obj['multiresult']);
	$cross[]=$obj['crosswordresult'];
	...
	$dd=@$dc[$i];
	if(@$dd->connect_id!=''){	
	mysql_query("insert into e_".$dd->connect_id."_edu_result_crossword set result='".$dd->result."', done_date='".$dd->done_date."', module_id='".$dd->module_id."', connect_id='".$dd->connect_id."', user_id='".$dd->user_id."', course_id='".$dd->course_id."', topic_id='".$dd->topic_id."', heading_id='".$dd->heading_id."'");
	}
	}
	}
	
	$multi[]=$obj['multiresult'];
	//echo '<pre>';
	//print_r($multi);
	...
	for($j=0; $j<$mcnt;$j++){	
		$dd1=@$dm[$j];
	if(@$dd1->connect_id!=''){
	mysql_query("insert into e_".$dd1->connect_id."_edu_result set course_id='".$dd1->course_id."', module_id='".$dd1->module_id."', topic_id='".$dd1->topic_id."', heading_id='".$dd1->heading_id."', total_question='".$dd1->total_question."', correct_question='".$dd1->correct_question."', worng_question='".$dd1->worng_question."', user_id='".$dd1->user_id."', connect_id='".$dd1->connect_id."'");
	}
	}
	}
	
	$draganddrop[]=$obj['dragdropresult'];
	//echo '<pre>';
	//print_r($multi);
	
	foreach($draganddrop as $ddr){
		$dcnt=count($ddr);
		//echo '<pre>';
		//print_r($ff);
	for($k=0; $k<$dcnt;$k++){	
		$dd2=@$ddr[$k];
	if(@$dd2->connect_id!=''){
	mysql_query("insert into e_".$dd2->connect_id."_edu_result_draganddrop set course_id='".$dd2->course_id."', module_id='".$dd2->module_id."', topic_id='".$dd2->topic_id."', heading_id='".$dd2->heading_id."', total_question='".$dd2->total_question."', correct_question='".$dd2->correct_question."', worng_question='".$dd2->worng_question."', user_id='".$dd2->user_id."', connect_id='".$dd2->connect_id."'");
	}
	}
	}
	
	$fillintheblankresult[]=$obj['fillintheblankresult'];
	//echo '<pre>';
	//print_r($multi);
	//$l=0;
	foreach($fillintheblankresult as $ff){
		$fcnt=count($ff);
		//echo '<pre>';
		//print_r($ff);
	for($l=0; $l<$fcnt;$l++){
	...
	if(@$dd3->connect_id!=''){
	//echo "insert into e_".$dd3->connect_id."_edu_result_fillintheblanks set course_id='".$dd3->course_id."', module_id='".$dd3->module_id."', topic_id='".$dd3->topic_id."', heading_id='".$dd3->heading_id."', total_question='".$dd3->total_question."', correct_question='".$dd3->correct_question."', worng_question='".$dd3->worng_question."', user_id='".$dd3->user_id."', connect_id='".$dd3->connect_id."'<br />";	
	mysql_query("insert into e_".$dd3->connect_id."_edu_result_fillintheblanks set course_id='".$dd3->course_id."', module_id='".$dd3->module_id."', topic_id='".$dd3->topic_id."', heading_id='".$dd3->heading_id."', total_question='".$dd3->total_question."', correct_question='".$dd3->correct_question."', worng_question='".$dd3->worng_question."', user_id='".$dd3->user_id."', connect_id='".$dd3->connect_id."'");
	}
	}
	}
	
	$truefalseresult[]=$obj['truefalseresult'];
	//echo '<pre>';
	//print_r($multi);
	
	foreach($truefalseresult as $tf){
			$tcnt=count($tf);
		//echo '<pre>';
		//print_r($ff);
	for($m=0; $m<$tcnt;$m++){
		$dd4=@$tf[$m];
	if(@$dd4->connect_id!=''){
	mysql_query("insert into e_".$dd4->connect_id."_edu_result_truefalse set course_id='".$dd4->course_id."', module_id='".$dd4->module_id."', topic_id='".$dd4->topic_id."', heading_id='".$dd4->heading_id."', total_question='".$dd4->total_question."', correct_question='".$dd4->correct_question."', worng_question='".$dd4->worng_question."', user_id='".$dd4->user_id."', connect_id='".$dd4->connect_id."'");
	}
	}
	}
	...
	public function refreshandclosepage(){
	?>	   <script>
   parent.window.hs.getExpander().close();
   parent.location.reload();
   </script>
...
public function insertfeedback()
	{
		mysql_query("insert into tbl_feedback set userid='".$_POST['userid']."', message='".$_POST['message']."', createddate=now()");
		// print_r($_POST); die;
		$query=$this->db->query("select * from tbl_feedback where userid='".$_POST['userid']."'");
        $pac_info= $query->rows;
		foreach($pac_info as $pac_info)
		{
			$feedback[]=array(
			'id' => $pac_info['id'],
			'userid' => $pac_info['userid'],
			'message' => $pac_info['message'],
			'done_date'=>$pac_info['createddate']
			);
		} 
...
public function insertinvoice()
	{
			$f_inv_date=date('Y-m-d');
		$nf_inv_date=date('Y-m-d');
		$df_inv_date=date('Y-m-d');
		$invamt=0;
		$prinvamt=0;
		$applicationid=$_POST['studentid'];
		$stdq=mysql_query("select * from student where preukid='".$applicationid."'");
				$stds=mysql_fetch_array($stdq);
				
				$studentname = @$stds['studentname'].' '.@$stds['surname'];
      			$address=@$stds['address1'];
				$city=@$stds['city1'];
				$postcode=@$stds['postcode'];
				$country=@$stds['country'];
				$studentenrolid=@$stds['referenceno'];
				$referenceno=@$stds['StudentReferenceEditNo'];
			
				$q=mysql_query("select max(autono) as autono from accountinvoice where 1");
				$s=mysql_fetch_array($q);
				
				$batq=mysql_query("select * from package where id='".$_POST['package']."'");
				$bats=mysql_fetch_array($batq);
				$invamt=$bats['pamt'];
				
				$piq=mysql_query("select balance as totalinvamount from accountinvoice where studentid='".$applicationid."' order by invoiceid DESC limit 0,1");
				$piqs=mysql_fetch_array($piq);
				$prinvamt=$piqs['totalinvamount'];
				$totalbalamt=$invamt+$prinvamt;
				if($s['autono']>0){
				$invno=	$s['autono']+1;
				}else{
				$invno='1';	
				...
				if(strlen(@$invno)==1){
                        $idd='000'.@$invno;
                    }elseif(strlen(@$invno)==2){
                        $idd='00'.@$invno;
                    }elseif(strlen(@$invno)==3){
                        $idd='0'.@$invno;
                    }else{ 
                        $idd=@$invno;
                    }
				...
				$invoiceno = @$idd;
				if($invamt!=0){
		$this->db->query("INSERT INTO `accountinvoice` 
				SET	invoice_no = '" . $invoiceno . "',					
				    autono = '" . $autono . "',					
				    studentid = '" . $applicationid . "',
				    invoice_date = '" . $f_inv_date . "',
					duedate='".$df_inv_date."',
					admission_Fee = '',
				    invoicename = 'Total',
				    course_fee = '".$invamt."',
					...
					createddate = now(),
					balance='".$totalbalamt."',
					totalinvamount='".$totalbalamt."',
					createdby = '" . @$this->session->data['userid'] . "'
		");	
		$invoiceid=$this->db->getLastID();
				}

	$query=$this->db->query("select * from accountinvoice where invoiceid='".$invoiceid."'");
        $invoice_info= $query->row;
	$today=@$invoice_info['invoice_date'];	 
	$agreementyear=@$invoice_info['invoice_no'];
	$name=@$invoice_info['invoicename'];
	$registrationfee=@$invoice_info['admission_Fee'];
	$coursefee=@$invoice_info['course_fee'];
	$extracoursefees = @$invoice_info['extracoursefees'];
	$other=@$invoice_info['other'];
	$total = round(($registrationfee+$coursefee+@$extracoursefees-$other),2);
     $balance = $total;
$colq=$this->db->query("select * from collegedata");
$col_info= $colq->row;      					
$bankname=@$col_info['bankname'];	 
	$accntname=@$col_info['accntname'];
	$bankacctno=@$col_info['bankacctno'];
	$banksortcode=@$col_info['banksortcode'];
	$branchidentifier=@$col_info['branchidentifier'];
		
//$data=array('contact'=>$requestconference);		 
$data=array('studentname' =>$studentname , 'address'=>$address, 'city'=>$city, 'postcode'=>$postcode, 'country'=>$country, 'studentenrolid'=>$studentenrolid, 'referenceno'=>$referenceno, 'invoiceid'=>$invoiceid, 'invoicedate'=>$today, 'agreementyear'=>$agreementyear, 'name'=>$name, 'registrationfee'=>$registrationfee, 'coursefee'=>$coursefee, 'extracoursefees'=>$extracoursefees, 'other'=>$other, 'total'=>$total, 'balance'=>$balance, 'bankname'=>$bankname, 'accntname'=>$accntname, 'bankacctno'=>$bankacctno, 'banksortcode'=>$banksortcode, 'branchidentifier'=>$branchidentifier);
echo json_encode($data);
exit;		 
    }	
public function insertreceipt(){
	
$susq=mysql_query("select coursename from course where courseid='".$_POST['courseid']."'");
	$suss=mysql_fetch_array($susq);
	
	
	$status='Your payment has been successfully received and a receipt for the same has been sent to you on the email address provided to us.';
	$rec = mysql_query("select max(receipt_no) as receiptno from remittance");
	$receiptDetails=mysql_fetch_array($rec);
	    	$new_receiptno = $receiptDetails['receiptno'] + 1;
			$receiptno= $new_receiptno;
	$this->db->query("insert into `remittance` 
                SET  
		...
		$q=mysql_query("select balance,invoiceid from accountinvoice where agreement='' and invoiceid='".$_POST['invoiceid']."' order by invoiceid desc limit 0,1");
		$n=mysql_num_rows($q);
		$s=mysql_fetch_array($q);
		if($n>0){
			
		$balance=str_replace('-','',$s['balance'])-@$_POST['amount'];
		//echo "update accountinvoice set balance='".$balance."' where invoiceid='".$s['invoiceid']."'";
		//die;
		mysql_query("update accountinvoice set balance='".$balance."' where invoiceid='".$s['invoiceid']."'");
		mysql_query("update remittance set receipttype='invoice', accountinvoiceid='".$s['invoiceid']."', invoicebalance='".$balance."' where receipt_id='".$rec_id."'");	
		}
...
$sender=$skts['sender'];
$host=$skts['serversmtp'];
$ci=mysql_query("select * from collegedata");
$college_info = mysql_fetch_array($ci);  
         $email=$college_info['adminemail'];
		 $admissionemail=$college_info['admissionemail'];
$sq=mysql_query("select studentname, surname, email from student where preukid='".$_POST['studentid']."'"); 
$ssq=mysql_fetch_array($sq);            
            $mailto = $ssq['email'];
            //$cc = 'ys@nwcreading.co.uk';
           $subject= "Receipt of ".$college_info['collegeName'];
           $message = '<html>
<head>
  <title>"'.$subject.'"</title>
</head>
<body>
    <table>
    <tr>
      <th align="left" colspan="3">Dear'.' '.$ssq['studentname'].' '.$ssq['surname'].', </br>
   </th>
    </tr>
    <tr>
      <th align="left" colspan="3"></br>
    ...
    <tr>
      <th align="left" colspan="3">Thank you for your recent payment towards your tuition fee for your course at the '.$college_info['collegeName'].'. Please find your payment receipt <a href="'.HTTP_SERVER.'html2pdf_v4.03/receipt.php?preukid='.$_POST['studentid'].'&receiptid='.$rec_id.'" target="_blank">attached here</a>.
   </th>
    </tr>
	...
	<tr><td>&nbsp;</td></tr>
	<tr><td>The Admissions Team</td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td><img width="150" height="55" src="http://www.collegeadministrator.org/'.@$college_info['foldername'].'/uploaded/collegedocuments/photo/'.@$college_info['collegelogo'].'"><br /><br /><img src="http://www.collegeadministrator.org/'.@$college_info['foldername'].'/image/green.jpg" /><br /><br />
Legal Disclaimer<br /><br />

Internet communications are not secure and therefore '.@$college_info['collegeName'].' does not accept legal responsibility for the contents of this message.Although '.@$college_info['collegeName'].' operates anti-virus programmes , it does not accept responsibility for any damage whatsoever that is caused by viruses being passed. Any views or opinions presented are solely those of the author and do not necessarily represent those of '.@$college_info['collegeName'].'.<br /><br />
<span style="font-size:9px;">'.@$college_info['collegeName'].' is the trading name of '.@$college_info['tradename'].', a company registered with The Companies House of England and Wales under company number '.$college_info['companynumber'].'</span></td></tr>
  </table>
</body>
</html>
';
 $headers = array ('From' => @$sender,'To' => @$mailto, 'Subject' => @$subject,'Content-Transfer-Encoding'=> '8bit\n'); 
 $mime = new Mail_mime("\n");
$mime->addCc($ccto);
$mime->addBcc($bccto);
$mime->setHTMLBody($message);
...
public function all_courses()
	...
	if(isset($this->session->data['userid'])){
		$this->data['all_course']=array();	
	$all_course=$this->model_klaspad_klaspad->all_course_new();
	foreach($all_course as $course){
		$this->data['all_course'][]=array(
					'id'=>$course['id'],
					'coursename' => $course['coursename'],
					'thumbimageupload'=>$course['thumbimageupload'],
					'description'=>$course['description']
					);
	$this->data['module'.$course['id']]=array();				
	${'module_course_wise'.$course['id']}=$this->model_klaspad_klaspad->module_course_wise_new($course['id']);
	//echo '<pre>';
	//print_r(${'module'.$course['id']});
	foreach(${'module_course_wise'.$course['id']} as $result)
				{
	...
	//$board_name=$this->model_klaspad_klaspad->board_name();
	$this->id       = 'content';
	$this->template = 'klaspad/new_courses.php';
	$this->render();	
	//$this->load->view('exercisedashboard/courses',$data);
	}else{
    $this->session->data['messages']='You must Login First.';
...
public function createinvoice()
	{
		...
		$stdq=mysql_query("select * from student where preukid='".$applicationid."'");
				$stds=mysql_fetch_array($stdq);
		$crsq=mysql_query("select coursename from course where courseid='".$stds['course1']."'");		
		$crss=mysql_fetch_array($crsq);
		$semq=mysql_query("select * from semester where semesterid='".$stds['semesterid']."'");		
		$sems=mysql_fetch_array($semq);
				$this->data['coursename']=@$crss['coursename'];
				$this->data['semestername']=@$sems['semestername'];
				$this->data['startdate']=@$sems['startdate'];
				$this->data['preukid']=@$stds['preukid'];
				$this->data['studentname'] = @$stds['studentname'].' '.@$stds['surname'];
      			$this->data['address']=@$stds['address1'].', '.@$stds['caddress1'];
				$this->data['city']=@$stds['city1'];
				$this->data['postcode']=@$stds['postcode1'];
				$this->data['country']=@$stds['contact_country'];
				$this->data['studentenrolid']=@$stds['referenceno'];
				$this->data['referenceno']=@$stds['StudentReferenceEditNo'];
	...
	$this->data['today']=@$invoice_info['invoice_date'];	 
	$this->data['agreementyear']=@$invoice_info['invoice_no'];
	$this->data['name']=@$invoice_info['invoicename'];
	$this->data['registrationfee']=@$invoice_info['admission_Fee'];
	$this->data['coursefee']=@$invoice_info['course_fee'];
	$this->data['extracoursefees'] = @$invoice_info['extracoursefees'];
	$this->data['other']=@$invoice_info['other'];
	//$this->data['total'] = round(($registrationfee+$coursefee+@$extracoursefees-$other),2);
    // $this->data['balance'] = $this->data['total'];
$colq=$this->db->query("select * from collegedata");
$col_info= $colq->row;      					
$this->data['bankname']=@$col_info['bankname'];	 
	$this->data['accntname']=@$col_info['accntname'];
	$this->data['bankacctno']=@$col_info['bankacctno'];
	$this->data['banksortcode']=@$col_info['banksortcode'];
	$this->data['branchidentifier']=@$col_info['branchidentifier'];
$this->id       = 'content';
	$this->template = 'klaspad/invoice_print.php';
	$this->render();		
//$data=array('contact'=>$requestconference);		 
//$data=array('studentname' =>$studentname , 'address'=>$address, 'city'=>$city, 'postcode'=>$postcode, 'country'=>$country, 'studentenrolid'=>$studentenrolid, 'referenceno'=>$referenceno, 'invoiceid'=>$invoiceid, 'invoicedate'=>$today, 'agreementyear'=>$agreementyear, 'name'=>$name, 'registrationfee'=>$registrationfee, 'coursefee'=>$coursefee, 'extracoursefees'=>$extracoursefees, 'other'=>$other, 'total'=>$total, 'balance'=>$balance, 'bankname'=>$bankname, 'accntname'=>$accntname, 'bankacctno'=>$bankacctno, 'banksortcode'=>$banksortcode, 'branchidentifier'=>$branchidentifier);
//echo json_encode($data);
...
$v=explode('_',$_GET['val']);
$studentid=$v[0];
$amount=$v[1];
$invoiceid=$v[2];	
$stdq=mysql_query("select course1 from student where preukid='".$studentid."'");
$stds=mysql_fetch_array($stdq);
$susq=mysql_query("select coursename from course where courseid='".$stds['course1']."'");
	$suss=mysql_fetch_array($susq);
	...
	$this->db->query("insert into `remittance` 
		...
		$q=mysql_query("select balance,invoiceid from accountinvoice where agreement='' and invoiceid='".$invoiceid."' order by invoiceid desc limit 0,1");
		$n=mysql_num_rows($q);
		$s=mysql_fetch_array($q);
		if($n>0){
			
		$balance=str_replace('-','',$s['balance'])-@$amount;
		//echo "update accountinvoice set balance='".$balance."' where invoiceid='".$s['invoiceid']."'";
		//die;
		mysql_query("update accountinvoice set balance='".$balance."' where invoiceid='".$s['invoiceid']."'");
		mysql_query("update remittance set receipttype='invoice', accountinvoiceid='".$s['invoiceid']."', invoicebalance='".$balance."' where receipt_id='".$rec_id."'");	
...
<?php		
//$this->redirect($this->url->https('klaspad/klaspad/all_courses'));		
//$data=array('status' =>$status);
//echo json_encode($data);
//exit;		
...
public function getMyStudent() {	   
		...
		$sql		 = " select *,C.coursename, A.flag as flag ";
		$sql		.= " from student A ";
		$sql		.= " Left join  course C on C.courseid = A.course1 ";
		$sql	    .= " where 1=1  ";
		$dw=mysql_query("select distinct courseid from course where courseLeader='".$_POST['staffid']."' ");	
		
		$z=1;
		$cid=0;
		while($dres=mysql_fetch_array($dw)){
		if($z==1){	
		$cid=$dres['courseid'];	
		}else{
			
		$cid=$cid.','.$dres['courseid'];	
		}
			
		$z++;}
		$sql      .=" and A.course1 in($cid) ";	
	$query=$this->db->query($sql);
        $std_info= $query->rows;
		foreach($std_info as $std_info)
		{
			if($std_info['photo']!=''){
				$photo='uploaded/photo/'.$std_info['photo'];
			}else{
				$photo='';
			}
			$student[]=array(
			'preukid' => $std_info['preukid'],
			'studentid' => $std_info['referenceno'],
			'referenceno' => $std_info['StudentReferenceEditNo'],
			'flag' => $std_info['flag'],
			'studentname' => $std_info['studentname'],
			'surname' => $std_info['surname'],
			'coursename'=>$std_info['coursename'],
			'status'=>$std_info['status'],
			'image'=>$photo
			);
		} 	
...
public function getStudentPersonalDetails() {	   
		$sql		 = " select *, t.title as titlename, C.coursename, s.semestername, A.flag as flag ";
		$sql		.= " from student A ";
		$sql		.= " Left join  title t on t.titleid = A.title ";
		$sql		.= " Left join  semester s on s.semesterid = A.semesterid ";
		$sql		.= " Left join  course C on C.courseid = A.course1 ";
		$sql	    .= " where preukid='".$_POST['preukid']."'  ";
	$query=$this->db->query($sql);
        $student_info= $query->row;
			
            if(@$student_info['referenceno']!=''){
               $studentenrolid = @$student_info['referenceno'];    
            }else{
                $studentenrolid='NA' ;
            } 
            
             $student_refno = $student_info['StudentReferenceEditNo'];  
         
        $studentid = @$student_info['preukid'];  
		$title = @$student_info['titlename'];
    	$FName = @$student_info['studentname'];
        $LName = @$student_info['surname'];
        
        $birthdate=@$student_info['birthdate']; 
        
        if(@$student_info['birthdate']!='') {
        $t_bdate=explode('-',$birthdate);
        $BirthDay=$t_bdate['0'];		
        $BirthMonth=$t_bdate['1'];
        $BirthYear=$t_bdate['2']; 
        }else{
          $BirthDay='00' ;
          $BirthMonth='00' ;
        ...
        $birthcountry=@$student_info['birthcountry'];
        $curemail = @$student_info['email'];
        $curphone = @$student_info['phoneno'];
        $curmobile = @$student_info['mobile'];
		$addressline1 = preg_replace('/[\r\n\,]+/','<br>',@$student_info['address1']);
      	$addressline2 = preg_replace('/[\r\n\,]+/','<br>',@$student_info['caddress1']);
        
		$city1 = @$student_info['city1'];
      	$country = @$student_info['contact_country'];
      	$postcode1 = @$student_info['postcode1'];
        $status = @$student_info['status'];
		$Nameofthecourse = @$student_info['coursename'];
		$Intakename = @$student_info['semestername']; 
		if(@$student_info['photo']!=''){
               $photoname = 'uploaded/photo/'.$student_info['photo'];    
            }else{
                $photoname='' ;
            }
		
		
	$data=array('studentenrolid'=>$studentenrolid, 'student_refno'=>$student_refno, 'title'=>$title, 'FName'=>$FName, 'LName'=>$LName, 'birthdate'=>$birthdate, 'Nationality'=>$Nationality, 'addressline1'=>$addressline1, 'addressline2'=>$addressline2, 'city'=>$city1, 'postcode'=>$postcode1, 'country'=>$country, 'curmobile'=>$curmobile, 'curphone'=>$curphone, 'curemail'=>$curemail, 'Nameofthecourse'=>$Nameofthecourse, 'Intakename'=>$Intakename, 'photoname'=>$photoname, 'status'=>$status);
	echo json_encode($data);
	exit;		
    }

public function getStudentCorrespondance() {	   
		$letter		 = array();	
		
		
				
		$sql		 = "select * from letters where studentid='".$_POST['preukid']."' order by letterid desc";
		
	$query=$this->db->query($sql);
        $ls= $query->rows;
		foreach($ls as $ls)
		{
			if($ls['dateforrecord']!='' && $ls['dateforrecord']!='0000-00-00'){
				$d=explode('-',$ls['dateforrecord']);
				$letterdate= $d[2].'-'.$d[1].'-'.$d[0]; 
			}else{ 
				$letterdate= ''; 
			}
			if($ls['applicantemail']!=''){ 
				$lettertype= 'Email'; 
			}else if($ls['smsemail']!=''){ 
				$lettertype= 'SMS'; 
			}else{ 
		...
		if($ls['applicantemail']!=''){
    $letterview='index.php?route=applicantmails/applicantmails/showmails&letterid='.$ls['letterid'].'&preukid='.$_POST['preukid'];
    	}else if($ls['applicantletter']!=''){
    $letterview='index.php?route=applicantmails/applicantmails/save&letterid='.$ls['letterid'].'&preukid='.$_POST['preukid'];
    	}else {
	$letterview='index.php?route=applicantmails/applicantmails/sendsms&letterid='.$ls['letterid'].'&preukid='.$_POST['preukid'];
		}
		$lettername=$ls['lettername'];	
			$letter[]=array(
			'letterid' => $ls['letterid'],
	...
	$query = $this->db->query("SELECT * FROM `documentinfo` where studentid='".$_POST['preukid']."'");
	$document_info = $query->rows;
	$document=array();
      		foreach($document_info as $document_info){
				$documentname='';
				if($document_info['doc_type'] == 'Bank Statement'){
					$documentname= 'uploaded/Bank/'.$document_info['documentname'];
				}
				if($document_info['doc_type'] == 'Academic Certificate'){
					$documentname= 'uploaded/Certificate/'.$document_info['documentname'];
				}
				if($document_info['doc_type'] == 'Passport'){
					$documentname= 'uploaded/passport/'.$document_info['documentname'];
				}
				if($document_info['doc_type'] == 'Other'){
					$documentname= 'uploaded/documents/'.$document_info['documentname'];
				}
				
				
            	$document[]=array(
      				'nameofdoc'=>$document_info['nameofdoc'],
                    'documentname'=>$documentname,
                    'doc_type'=>$document_info['doc_type'],
      				'createddate'=>$this->functions->getFullDate($document_info['createddate'], 'd-m-Y')
                );
      		}
...
public function activate_courses(){
  $csq=mysql_query("select statuss from course where courseid='".$_GET['courseid']."'");
  $css=mysql_fetch_array($csq);
  if($css['statuss']=='1'){
	  mysql_query("update course set statuss='0' where courseid='".$_GET['courseid']."'");
	  mysql_query("update e_10_edu_courses set statuss='0' where id='".$_GET['courseid']."'");
  }else{
	  mysql_query("update course set statuss='1' where courseid='".$_GET['courseid']."'");
	  mysql_query("update e_10_edu_courses set statuss='1' where id='".$_GET['courseid']."'");
  }
  $this->redirect($_SERVER['HTTP_REFERER']);
}

public function mobile_getcoutsedetails_new()
	{
		$this->load->model('klaspad/klaspad');
	$query=$this->db->query("select * from e_".$_POST['connectionid']."_edu_courses where id='".$_POST['courseid']."'");	
	$mm=$query->row;
	
	$module_course_wise=array();
	
	$queryyy= $this->db->query("select id,modulename,moduletype from e_".$_POST['connectionid']."_edu_modules where course_id='".$_POST['courseid']."' order by id asc");
	$module_course_wisee=$queryyy->rows;				
	//$module_course_wise=$this->model_klaspad_klaspad->module_course_wise($_GET['courseid']);
	//echo '<pre>';
	//print_r(${'module'.$course['id']});
	foreach($module_course_wisee as $result){
			$query= $this->db->query("select * from e_".$_POST['connectionid']."_edu_topics where module_id='".$result['id']."'  order by shortorder asc ");	
	...
	$zz++;}
	$resource=array();			
	$query1= $this->db->query("select headingname,id,exerciestype, topic_id from e_".$_POST['connectionid']."_edu_headings where topic_id in (".$topic_id.") and exerciestype in ('Powerpoint presentation exercise','Add Video','Files') order by shortorder asc");		
	$mm1=$query1->rows;
	foreach($mm1 as $exe_dta){
	$resource[]=array(
			'id' => $exe_dta['id'],
	...
	$coursename=$mm['coursename'];			
	$description=$mm['description'];
	$learningoutcomes=$mm['learningoutcomes'];
	$videoupload=$mm['videoupload'];
	$CourseLeader=$mm['CourseLeader'];
	$pq=mysql_query("select * from package where id='".$_POST['package']."'");
$psq=mysql_fetch_array($pq);
$cp= explode(',',$psq['courseprovided']);
if(in_array('Emails',$cp)){
$email='1';	
}else{
$email='0';
}
if(in_array('Telephone',$cp)){
$phone='1';
}else{
$phone='0';	
}
if(in_array('Conference',$cp)){
$conf='1';	
}else{
$conf='0';	
}
...
if(in_array('Whiteboard',$cp)){
$whb='1';	
}else{
$whb='0';	
}
if(in_array('Content',$cp)){
$cont='1';	
}else{
$cont='0';	
}
$pamount=$psq['amount'].'(£'.$psq['pamt'].')';
$pdiscription=html_entity_decode($psq['description']);
$stfq=mysql_query("select * from staff where staffid='".$CourseLeader."'");
$stfs=mysql_fetch_array($stfq);

$staffpersonalvideo=$stfs['personalvideo'];
$staffimage='uploaded/photo/'.$stfs['photo'];	
$staffname=$stfs['staffname'].' '.$stfs['surname'];	
$staffinstitution=$stfs['institutionname'];
$staffpersonalstatement=$stfs['personalstatement'];	


$data=array('coursename'=>$coursename, 'description'=>$description, 'learningoutcomes'=>$learningoutcomes, 'videoupload'=>$videoupload, 'email'=>$email, 'phone'=>$phone, 'conference'=>$conf, 'chat'=>$chat, 'whiteboard'=>$whb, 'content'=>$cont, 'packageamount'=>$pamount, 'packagedescription'=>$pdiscription, 'staffpersonalvideo'=>$staffpersonalvideo, 'staffimage'=>$staffimage, 'staffname'=>$staffname, 'staffinstitution'=>$staffinstitution, 'staffpersonalstatement'=>$staffpersonalstatement, 'modulelistwithresource'=>$module_course_wise);
	echo json_encode($data);
	exit;
...
public function new_all_topic_resource_new(){
		if(!isset($_POST['connectionid'])){
		$_POST['connectionid']=10;
		$_POST['id']=43;
			}
		...
		//if(isset($tcss['id'])){
		$str.=" and tt.id='".$_POST['topicid']."'";
		$str.=" and eh.id='".$_POST['headingid']."'";
		//}
		//echo "select ee.conversationtopic, cc.coursename,ee.video_icon,ee.question ,ea.id as favid, cc.description as course_description, cc.learningoutcomes as course_learningoutcomes,  eh.headingname, eh.rssfeedlink, ee.rssfeedlink as excercise_rssfeedlink, ee.excercises_video ,cc.id as course_id,  ee.excercises_youtube, ee.id as resourceid,  ee.description, ee.learningoutcomes, ee.notice, ee.upload_folder, ee.uploadimage, ee.excercisename,ee.excercises_embed, ee.excercises_video, ee.excercises_audio, eh.exerciestype, cc.id as courseid, mm.id as moduleid, tt.id as tid from e_".$s['connectionid']."_edu_headings as eh inner join e_".$s['connectionid']."_edu_excercises as ee on ee.topic_id=eh.id left join e_".$_POST['connectionid']."_edu_fav as ea on ee.id=ea.resourceid inner join e_".$s['connectionid']."_edu_topics as tt on eh.topic_id=tt.id inner join e_".$s['connectionid']."_edu_modules as mm on mm.id=tt.module_id inner join e_".$s['connectionid']."_edu_courses as cc on cc.id=mm.course_id where (eh.exerciestype = 'Powerpoint presentation exercise' or eh.exerciestype ='Add Folder' or eh.exerciestype ='Files' or eh.exerciestype ='Add Audio' or eh.exerciestype ='Add Video') $str  order by eh.shortorder <br />";
		$query=$this->db->query("select ee.conversationtopic, cc.coursename,ee.video_icon,ee.question ,ea.id as favid, cc.description as course_description, cc.learningoutcomes as course_learningoutcomes,  eh.headingname, eh.rssfeedlink, ee.rssfeedlink as excercise_rssfeedlink, ee.excercises_video ,cc.id as course_id,  ee.excercises_youtube, ee.id as resourceid,  ee.description, ee.pptimagepath, ee.learningoutcomes, ee.notice, ee.upload_folder, ee.uploadimage, ee.excercisename,ee.excercises_embed, ee.excercises_video, ee.excercises_audio, eh.exerciestype, cc.id as courseid, mm.id as moduleid, tt.id as tid from e_".$_POST['connectionid']."_edu_headings as eh inner join e_".$_POST['connectionid']."_edu_excercises as ee on ee.topic_id=eh.id left join e_".$_POST['connectionid']."_edu_fav as ea on ee.id=ea.resourceid inner join e_".$_POST['connectionid']."_edu_topics as tt on eh.topic_id=tt.id inner join e_".$_POST['connectionid']."_edu_modules as mm on mm.id=tt.module_id inner join e_".$_POST['connectionid']."_edu_courses as cc on cc.id=mm.course_id where (eh.exerciestype = 'Powerpoint presentation exercise' or eh.exerciestype ='Add Folder' or eh.exerciestype ='Files' or eh.exerciestype ='Add Audio' or eh.exerciestype ='Add Video') $str $str1  order by eh.shortorder ");	
	$mm = $query->rows;	
...
foreach($mm as $mms){
	...
	$imgpath='klaspad/uploads/'.$s['connectionid'];
	if($mms['exerciestype']=='Powerpoint presentation exercise'){
if($handle = opendir('klaspad/uploads/'.$_POST['connectionid'].'/'.$mms['course_id'].'/ppt/'.$mms['resourceid'])) {
    while (false !== ($entry = readdir($handle))) {
        if ($entry != "." && $entry != "..") {
$url[] = 'klaspad/uploads/'.$s['connectionid'].'/'.$mms['course_id'].'/ppt/'.$mms['resourceid'].'/'.$entry;
        }
...
$query1=$this->db->query('select * from e_'.$_POST['connectionid'].'_edu_excercises_discussion where resourceid="'.$mms['resourceid'].'"');	
$disc=$query1->rows;
$discussion=array();	
foreach($disc as $dis){
$que=$this->db->query('select ea.assignment, ea.connectionid, ea.user_id, ea.createddate from e_'.$_POST['connectionid'].'_edu_ans_assignment ea where ea.assignment_id="'.$dis['id'].'" order by ea.id desc');		
$mmk = $que->rows;	
$url1=array();
foreach($mmk as $mmkk){
$msq=mysql_query("select eu.user_image, eu.demo_contact_person from e_".$mmkk['connectionid']."_edu_user as eu where eu.id='".$mmkk['user_id']."'");	
...
if(isset($_POST['userid'])){
//echo "select * from e_".$s['connectionid']."_edu_notes where courseid='".$mms['resourceid']."' and userid='".$_POST['userid']."'<br />";	
$query2=$this->db->query("select * from e_".$_POST['connectionid']."_edu_notes where courseid='".$mms['resourceid']."' and userid='".$_POST['userid']."'");	
$not=$query2->rows;
$notes=array();	
foreach($not as $no){
...
$query3=$this->db->query("select * from e_".$_POST['connectionid']."_edu_excercises_assignment where resourceid='".$mms['resourceid']."'");	
$assign=$query3->rows;
$assignment=array();	
foreach($assign as $ass){
$assignment[]=array('id' => $ass['id'], 
...
$query4=$this->db->query("select c.*, h.headingname from e_".$_POST['connectionid']."_edu_excercises_crossword as c left join e_".$_POST['connectionid']."_edu_headings as h on c.topic_id=h.id where c.resourceid='".$mms['resourceid']."'");	
$crswrd=$query4->rows;
$crossword=array();	
//$this->data['crossword'][]=$crswrd;	
foreach($crswrd as $ass1){
...
$query5=$this->db->query("select c.*, h.headingname from e_".$_POST['connectionid']."_edu_excercises_multiplechoice as c left join e_".$_POST['connectionid']."_edu_headings as h on c.topic_id=h.id where c.resourceid='".$mms['resourceid']."' group by c.topic_id");	
$crswrd2=$query5->rows;
$multiple=array();	
//$this->data['crossword'][]=$crswrd;	
foreach($crswrd2 as $ass1){
...
$query6=$this->db->query("select c.*, h.headingname from e_".$_POST['connectionid']."_edu_excercises_fillintheblanks as c left join e_".$_POST['connectionid']."_edu_headings as h on c.topic_id=h.id where c.resourceid='".$mms['resourceid']."' group by c.topic_id");	
$crswrd3=$query6->rows;
$fill=array();	
//$this->data['crossword'][]=$crswrd;	
foreach($crswrd3 as $ass1){
...
$query7=$this->db->query("select c.*, h.headingname from e_".$_POST['connectionid']."_edu_excercises_descripting as c left join e_".$_POST['connectionid']."_edu_headings as h on c.topic_id=h.id where c.resourceid='".$mms['resourceid']."' group by c.topic_id");	
$crswrd4=$query7->rows;
$descripting=array();	
//$this->data['crossword'][]=$crswrd;	
foreach($crswrd4 as $ass1){
...
$query8=$this->db->query("select c.*, h.headingname from e_".$_POST['connectionid']."_edu_excercises_truefalse as c left join e_".$_POST['connectionid']."_edu_headings as h on c.topic_id=h.id where c.resourceid='".$mms['resourceid']."' group by c.topic_id");	
$tf=$query8->rows;
$truefalse=array();	
//$this->data['crossword'][]=$crswrd;	
foreach($tf as $ass1){
...
$query9=$this->db->query("select c.*, h.headingname from e_".$_POST['connectionid']."_edu_excercises_draganddrop as c left join e_".$_POST['connectionid']."_edu_headings as h on c.topic_id=h.id where c.resourceid='".$mms['resourceid']."' group by c.topic_id");	
$dd=$query9->rows;
$draganddrop=array();	
//$this->data['crossword'][]=$crswrd;	
foreach($dd as $ass1){
...
//print_r($notes);
$queee1=$this->db->query('select comment from e_'.$_POST['connectionid'].'_edu_conversationtopic where conversation_id="'.$mms['resourceid'].'"');
$status=$queee1->rows;
$conversationtopic_comments=array();
foreach($status as $stat){
$conversationtopic_comments[] = $stat['comment'];
...
public function addstickynotes(){
	$this->id       = 'content';
	$this->template = 'klaspad/add_stickynotes.php';	
	$this->render();	
}

public function insert_stickynotes(){
	mysql_query("insert into stickynotes set content='".$_POST['content']."', headingid='".$_POST['headingid']."', userid='".$_POST['userid']."'");	
	$this->redirect($_SERVER['HTTP_REFERER']);
	/*?>
   <script>
   parent.window.hs.getExpander().close();
...
public function update_stickynotes(){
	mysql_query("update stickynotes set content='".$_POST['content']."' where id='".$_GET['id']."'");	
	//$this->redirect($_SERVER['HTTP_REFERER']);
	?>
   <script>
   parent.window.hs.getExpander().close();
...
public function deletestickynotes(){
	mysql_query("delete from stickynotes where id='".$_GET['id']."'");	
	$this->redirect($_SERVER['HTTP_REFERER']);
}

public function timeline(){
	$this->id       = 'content';
	$this->template = 'klaspad/timeline.php';	
	$this->render();	
}
