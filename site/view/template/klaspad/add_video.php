...
<a href="index.php?route=klaspad/klaspad/module_activity&moduleid=<?php echo $_GET['moduleid']; ?>&topicid=<?php echo $_GET['topicid']; ?>&headingid=<?php echo $headingid1; ?>&courseid=<?php echo $_GET['courseid']; ?>&allresource=<?php echo $_GET['allresource']; ?>&previd=<?php echo $headingid1; ?>&nextid=<?php echo $nextid1; ?>">Previous Resource</a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php } ?>
<?php
$headingid='';
...
<?php if($exedata['excercises_video']!=''){?>
<?php if($yx==1){ ?>
<video width="100%" height="480" autoplay controls>
<source src="<?php echo $exedata['excercises_video']; ?>" type="video/mp4">
</video>
<?php }else{ ?>
...
<?php } ?>
<?php } ?>
<?php  if($exedata['excercises_youtube']!=''){ $lkt=explode('?v=',$exedata['excercises_youtube']);
if (strpos($lkt[1],'&') !== false) {
    $jj=explode('&',$lkt[1]);
	$kkkkkk=$jj[0];
}else{
	$kkkkkk=$lkt[1];
...
?>
<iframe width="100%" height="480" src="//www.youtube.com/embed/<?php echo $kkkkkk; ?>" frameborder="0" allowfullscreen></iframe>
<?php } ?>
<?php  if($exedata['excercises_embed']!=''){
echo html_entity_decode($exedata['excercises_embed']);
 } ?>
...
<!--<a href="index.php?route=klaspad/klaspad/addstickynotes&headingid=<?php echo $_GET['headingid']; ?>&userid=<?php echo $_SESSION['userid']; ?>" onClick="return hs.htmlExpand(this, { objectType: 'iframe', preserveContent: false, width:350, height:375} )">Add</a> -->
  ...
  <?php /*?><a href="javascript:void(0);" onClick="showtext3('assignmentdiv<?php echo $kkk1; ?>');" style="text-decoration:none;"><li style="list-style:none; float:left;"><?php echo  '<strong>'.$kkk1.'. </strong>';?></li><li style="list-style:none; float:left;"> <?php echo '<strong>'.stripslashes(html_entity_decode($ass['topic'])).'</strong>'; ?></li></a><?php */?>
...
<?php if($sasq['submitted']==0){ ?>
 ...
 <?php } ?>
  ...
  <ul>
  <li style="list-style:none; float:left;"><?php echo  $reference; ?>
  </li>
  <div class="clear"></div>
  </ul>
  </div>
